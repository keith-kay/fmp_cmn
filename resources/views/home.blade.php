        ...
        <div class="row">
            <div class="col-md-8">
                <div class="text-block">
                    <p class="welcome-text">Welcome to <strong style="color: #153037; font-weight:600;">Fumba
                            Ports</strong> Canteen</p>
                </div>
                <div class="mx-2">
                    <a href="{{ route('login') }}" class="btn btn-nav fw-bold mx-4 btn-lg"
            ...
            <div class="col-md-4 d-none d-md-block">
                <div class="image-div">
                    <div class="mx-auto" style="width: 500px; height: 350px;">
                        ...
                        <dotlottie-player src="https://lottie.host/7145321f-a493-4fd2-bceb-70f7dd73f86f/Y0OsIyfEzi.json"
